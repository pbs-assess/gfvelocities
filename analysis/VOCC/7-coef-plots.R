...
setwd(here::here())
compile("analysis/VOCC/meta-analytic-model/vocc_regression.cpp")
dyn.load(dynlib("analysis/VOCC/meta-analytic-model/vocc_regression"))
source("analysis/VOCC/meta-analytic-model/vocc-regression-functions.R")
